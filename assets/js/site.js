...
(function(){
  ...
  /* ═══════════════════ 5. PLYR ═══════════════════
     Используем готовый Plyr вместо самописного плеера.
     Работает и с обычным видео, и с кружочками. */

  var plyrInstances = []; // Храним ссылки на все плееры

  function initPlyrVideo(videoEl, isRound){
  ...
  /* В ленте показываем только постер с кнопкой. Плеер создаётся
     при клике — так страница легче и не грузит видео заранее. */
